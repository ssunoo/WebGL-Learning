...
var FSHADER_SOURCE = `
    ...
    void main(){
        ...
        if( sqrt(texColor0[0] * texColor0[0] + texColor0[1] * texColor0[1] + (texColor0[2] - 1.0) * (texColor0[2] - 1.0) ) < 0.6) {
          texColor = texColor1;
        }
        else if( sqrt( (texColor0[0] - 1.0) * (texColor0[0] - 1.0) + texColor0[1] * texColor0[1] + texColor0[2] * texColor0[2] ) < 0.3 &&
                 sqrt( (texColor2[0] - 1.0) * (texColor2[0] - 1.0) + (texColor2[1] - 1.0) * (texColor2[1] - 1.0) + (texColor2[2] - 1.0) * (texColor2[2] - 1.0) ) < 0.7) {
...
function draw(){
    ...
    gl.bindTexture(gl.TEXTURE_2D, textures["LVTexture.jpg"]);
    gl.uniform1i(program.u_Sampler1, 1);

    gl.activeTexture(gl.TEXTURE2);
    gl.bindTexture(gl.TEXTURE_2D, textures["heart.jpg"]);
