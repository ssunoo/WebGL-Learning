...
async function main(){
    ...
    sonicObj = await loadOBJtoCreateVBO('low-poly-fox-by-pixelmannen.obj');
    ...
    normalMapImage.src = "normalmap.jpg";
...
function draw(){
  ...
  // mdlMatrix.setTranslate(0.0, 0.0, 0.0);
  mdlMatrix.setRotate(angleX, 0, 1, 0);//for mouse rotation
  mdlMatrix.rotate(angleY, 1, 0, 0);//for mouse rotation
